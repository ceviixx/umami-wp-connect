		...
		case 'setup':
			$screen->add_help_tab(
				array(
					...
					'content' => __( '<p><strong>Quick Setup Guide</strong></p>' .
								'<ol>' .
			...
			$screen->add_help_tab(
				array(
					...
					'content' => __( '<p><strong>Mode</strong><br>' .
								...
								'<strong>async</strong>: Load as soon as possible (may execute before DOM is ready).</p>', 'umami-connect' ),
				)
			);
			break;
		case 'share-url':
...
function umami_connect_add_help_events_overview() {
	...
	$screen->add_help_tab(
		array(
			...
			'title'   => __( 'Overview', 'umami-connect' ),
			'content' => __( '<p><strong>Events Overview</strong></p>' .
						'<p>This page provides a centralized overview of all Umami tracking events configured across your site.</p>' .
						'<p>You can view, search, edit, and manage events from various sources in one place.</p>', 'umami-connect'),
		)
	);
	...
	$screen->add_help_tab(
		array(
			...
			'content' => __( '<p><strong>Creating Events</strong><br>' .
						...
						'<p>Once created, events will appear in this overview for further management.</p>', 'umami-connect' ),
		)
	);
	...
	$screen->add_help_tab(
		array(
			...
			'content' => __( '<p><strong>Filter View</strong><br>' .
						...
						'• Use "Delete" to remove event tracking while preserving the original content</p>' , 'umami-connect'),
		)
	);
	...
	$screen->add_help_tab(
		array(
			...
			'content' => __( '<p><strong>Event Naming</strong><br>' .
						...
						'• Configuration changes are reflected immediately in your tracking</p>', 'umami-connect')
		)
	);
		...
		case 'host-url':
			$screen->add_help_tab(
				array(
					...
					'title'   => __( 'Overview', 'umami-connect' ),
					'content' => __( '<p><strong>Host URL override</strong></p>' .
								...
								'<p>Maps to <code>data-host-url</code>.</p>', 'umami-connect'),
				)
			);
			$screen->add_help_tab(
				array(
					...
					'content' => sprintf(
						...
						__( '<p>Enter a full URL (e.g. %1$s). Leave empty to use the script\'s own host.</p>', 'umami-connect'),
		...
		case 'auto-track':
			$screen->add_help_tab(
				array(
					...
					'title'   => __( 'Overview', 'umami-connect' ),
					'content' => __( '<p><strong>Disable auto tracking</strong></p>' .
								...
								'<p><em>Note:</em> The plugin\'s Automation features are separate and can still emit events.</p>', 'umami-connect'),
				),
			);
			break;
		case 'domains':
			$screen->add_help_tab(
				array(
					...
					'title'   => __( 'Overview', 'umami-connect' ),
					'content' => __( '<p><strong>Allowed domains</strong></p>' .
								...
								'<p>Maps to <code>data-domains</code>.</p>', 'umami-connect' ),
				)
			);
			break;
		case 'tag':
		...
		case 'exclude-search':
			$screen->add_help_tab(
				array(
					...
					'title'   => __( 'Overview', 'umami-connect' ),
					'content' => __( '<p><strong>Exclude search</strong></p>' .
								'<p>Ignores URL query parameters when collecting page views. Maps to <code>data-exclude-search</code>.</p>', 'umami-connect' ),
				)
			);
			break;
		case 'exclude-hash':
			$screen->add_help_tab(
				array(
					...
					'title'   => __( 'Overview', 'umami-connect' ),
					'content' => __( '<p><strong>Exclude hash</strong></p>' .
								'<p>Ignores the URL hash (fragment) when collecting page views. Maps to <code>data-exclude-hash</code>.</p>', 'umami-connect' ),
				)
			);
			break;
		case 'dnt':
			$screen->add_help_tab(
				array(
					...
					'title'   => __( 'Overview', 'umami-connect' ),
					'content' => __( '<p><strong>Do Not Track</strong></p>' .
								'<p>Respects the user\'s browser DNT preference. Maps to <code>data-do-not-track</code>.</p>', 'umami-connect' ),
				)
			);
			break;
		case 'before-send':
		default:
			$screen->add_help_tab(
				array(
					...
					'title'   => __( 'Overview', 'umami-connect' ),
					'content' => __( '<p><strong>beforeSend</strong></p>' .
								...
								'</ul>' .
								'<p>Maps to <code>data-before-send</code>.</p>', 'umami-connect' ),
				)
			);
			break;
	}
