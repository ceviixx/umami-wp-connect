...
function umami_connect_welcome_page() {
	?>
	<div class="wrap">
		<div style="background: linear-gradient(135deg, #1a1a1a 0%, #3a3a3a 100%); color: #ffffff; padding: 40px 48px; border-radius: 12px; margin: 20px 0 32px 0; box-shadow: 0 4px 16px rgba(0,0,0,0.2);">
